...
| Full workspace (`npm run check`) | Kernel integration breaks native/Wasm builds, browser probe or required checks. | Formatting/contracts/types/Rustfmt/Clippy/tests/native release/Wasm+web/browser stages all pass. | IN PROGRESS on e269ee1: all stages through native/Wasm/web passed;3 browser checks pending in tool session80185. | Diagnose actual stage and rerun after correction. |
